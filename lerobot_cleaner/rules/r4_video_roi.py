...
from lerobot_cleaner.types import EpisodeWork, VideoTransform


class VideoRoiCropRule(Rule):
    name = "video_roi_crop"
    ...
    def apply(self, work: EpisodeWork) -> None:
        ...
        for config_key, roi in self.config.rois.items():
            ...
            transform.crop_ratio = (roi.x_ratio, roi.y_ratio, roi.w_ratio, roi.h_ratio)
